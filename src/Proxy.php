 ...
 * @method static \Behamin\ServiceProxy\Response\ResponseWrapper patch(string $url, array $data = [])
 * @method static \Behamin\ServiceProxy\Response\ResponseWrapper post(string $url, array $data = [])
 * @method static \Behamin\ServiceProxy\Response\ResponseWrapper put(string $url, array $data = [])
 * @method static \Behamin\ServiceProxy\Response\ResponseWrapper send(string $method, string $url, array $options = [])
