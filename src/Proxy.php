 ...
 * @method static \Behamin\ServiceProxy\Responses\ProxyResponse request(Request $request, string $service)
 * @method static \Behamin\ServiceProxy\Responses\ProxyResponse get(string $url, array|string|null $query = null)
 * @method static \Behamin\ServiceProxy\Responses\ProxyResponse head(string $url, array|string|null $query = null)
 * @method static \Behamin\ServiceProxy\Responses\ProxyResponse patch(string $url, array $data = [])
 * @method static \Behamin\ServiceProxy\Responses\ProxyResponse post(string $url, array $data = [])
 * @method static \Behamin\ServiceProxy\Responses\ProxyResponse put(string $url, array $data = [])
 * @method static \Behamin\ServiceProxy\Responses\ProxyResponse delete(string $url, array $data = [])
 * @method static \Behamin\ServiceProxy\Responses\ProxyResponse send(string $method, string $url, array $options = [])
